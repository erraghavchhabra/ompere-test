      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        ...
        <div className="relative overflow-hidden rounded-[3rem] border border-orange-100 bg-white shadow-[0_25px_100px_rgba(240,112,32,0.18)]">
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-16 text-center">
            ...
            {/* Heading */}
            <h1 className="text-4xl md:text-5xl xl:text-5xl font-bold text-[#1a1a1a] leading-[1.2]">
              Want To Buy Used Generators?
              <span className="block mt-6 bg-gradient-to-r from-[#f07020] to-[#ff985c] bg-clip-text text-transparent leading-[1.2] pb-2">
                Coming Soon
              </span>
            </h1>
            {/* Description */}
